						...
						<form id="login-form">
							...
							<div class="col-md-12 col-xs-12">
								<div class="form-group">
									...
									<div class="input-group">
									  <span class="input-group-addon" id="basic-addon1"><i class="fas fa-envelope"></i></span>
									  <input type="text" class="form-control" name="email" id="email" placeholder="Enter Email" onfocus="this.value=''">
									</div>
								</div>
							</div>
							
							<div class="col-md-12 col-xs-12">
								<button type="submit" class="btn btn-submit pull-right">Register My Account</button>
							</div>
							<div class="col-md-12 col-xs-12">
								
								<hr>
								<h4 style="text-align:center;font-weight:bold">Already Registered User? </h4>
							</div>
							<div class="col-md-12 col-xs-12">
								<center>
									<a href="login.php" class="btn btn-primary"><i class="fas fa-sign-in-alt"></i> CLICK HERE TO LOGIN</a>
								</center>
							</div>
						</form>
					</div>
